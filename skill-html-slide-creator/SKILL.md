---
name: html-slide-creator
description: >-
  Use this skill when the user asks to create, design, or edit presentation slides
  in HTML/Tailwind CSS format with browser-based inline editing (contenteditable)
  and zero-margin PDF export (16:9 or 4:3 aspect ratios). Also use when
  reverse-engineering slide images into editable HTML slides, or asking for
  conceptual AI-generated images in slides.
---

# HTML Slide Creator (編集可能HTMLスライド生成スキル)
