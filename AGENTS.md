...
2. `rsync` sync to `.agents/skills/ainativeslide/` is completed if skills or templates changed.
3. Git commit messages follow standard Conventional Commits (e.g., `feat: ...`, `fix: ...`, `refactor: ...`, `docs: ...`).
