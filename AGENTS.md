...
- **Companion Sub-Skill / Sister Project**:
  - `AINativeSlide-Template-Builder` (Repo: `../AINativeSlide-Template-Builder/`, Skill: `.agents/skills/ainativeslide-template-builder/`) converts corporate presentation templates (PPTX, PDF, Keynote, screenshots) into AINativeSlide-compliant design templates (`assets/corporate_default.html`).
