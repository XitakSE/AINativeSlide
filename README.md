...
2. [実装済み機能一覧](#実装済み機能一覧)
   ...
   - [8. 全体フォントサイズ動的スケーリング](#8-全体フォントサイズ動的スケーリング)
   - [9. 企業公式デザインテンプレート（CI/VI統一・自社PPTX連携）](#9-企業公式デザインテンプレートcivi統一自社pptx連携)
   - [10. インラインSVGビジネスチャート & 比較マトリクステーブル](#10-インラインsvgビジネスチャート--比較マトリクステーブル)
